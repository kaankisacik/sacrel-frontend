          ...
          <div class="bg-white rounded-lg shadow-md p-6">
            ...
            <div class="space-y-3">
              <label class="flex items-center p-3 border border-gray-300 rounded-lg cursor-pointer hover:bg-gray-50">
                ...
                />
                <span class="ml-3">Kredi Kartı</span>
              </label>
              <label class="flex items-center p-3 border border-gray-300 rounded-lg cursor-pointer hover:bg-gray-50">
                <input
                  v-model="paymentMethod"
                  ...
                  class="text-black focus:ring-black"
                />
                <span class="ml-3">Banka Havalesi</span>
              </label>
              <label class="flex items-center p-3 border border-gray-300 rounded-lg cursor-pointer hover:bg-gray-50">
                <input
                  v-model="paymentMethod"
                  ...
                  class="text-black focus:ring-black"
                />
                <span class="ml-3">Kapıda Ödeme</span>
              </label>
            </div>
          </div>
        </div>
...
const completeOrder = async () => {
  ...
  try {
    ...
    // 1. Cart'ı güncelle (customer info, shipping address)
    // 2. Payment session oluştur
    // 3. Siparişi tamamla
