                ...
                <form class="space-y-6" @submit.prevent="handleRegister">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <div class="mt-1">
                                <input id="first_name" v-model="form.first_name" name="first_name" type="text"
                        ...
                        <div>
                            ...
                            <div class="mt-1">
                                <input id="last_name" v-model="form.last_name" name="last_name" type="text"
                    ...
                    <div>
                        ...
                        <div class="mt-1">
                            <input id="phone" v-model="form.phone" name="phone" type="tel" autocomplete="tel"
                                class="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                    ...
                    <div class="flex items-center">
                        ...
                        <label for="terms" class="ml-2 block text-sm text-gray-900">
                            <NuxtLink to="/policies/terms" class="text-indigo-600 hover:text-indigo-500">Kullanım
                                koşullarını</NuxtLink>
                            ve
                            <NuxtLink to="/policies/privacy" class="text-indigo-600 hover:text-indigo-500">gizlilik
                                politikasını</NuxtLink>
                            kabul ediyorum
                        </label>
                    </div>
...
const isFormValid = computed(() => {
    console.log("Form validation:", form.first_name, form.last_name, form.email, form.password, form.confirmPassword, form.acceptTerms);
